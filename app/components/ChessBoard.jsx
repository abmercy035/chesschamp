...
export function ChessBoard({ board = initialBoard, onSquareClick }) {
	...
	return (
		<div className="inline-block relative w-full max-w-2xl mx-auto">
			{/* Chess board frame */}
			<div className="p-4 sm:p-6 glass rounded-3xl backdrop-blur-xl border border-white/20 chess-shadow">
				{/* Coordinates - Top */}
				...
				<div className="flex items-center justify-center gap-2 sm:gap-4">
					...
					{/* The board */}
					<div className="grid grid-cols-8 grid-rows-8 border-2 sm:border-4 border-yellow-400/30 rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl flex-1 max-w-lg">
